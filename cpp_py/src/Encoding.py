...
_BOARD_SHAPE = ChessGame.representation_shape()
...
def filter_policy_with_en_passant_moves_then_get_moves_and_probabilities(
    policy: np.ndarray, board: ChessBoard
) -> list[MoveScore]:
    """
...
def __filter_policy_with_legal_moves_and_en_passant_moves(policy: np.ndarray, board: ChessBoard) -> np.ndarray:
    """
    ...
    legal_moves_encoded = ChessGame.encode_moves(board.get_valid_moves() + en_passant_moves)  # type: ignore
...
@timeit
def filter_policy_then_get_moves_and_probabilities(policy: np.ndarray, board: ChessBoard) -> list[MoveScore]:
    """
    Gets a list of moves with their corresponding probabilities from a policy.
...
def filter_moves(moves: list[MoveScore], board: ChessBoard) -> list[MoveScore]:
    """
    ...
    """
    legal_moves_encoded = ChessGame.encode_moves(board.get_valid_moves())
...
def __filter_policy_with_legal_moves(policy: np.ndarray, board: ChessBoard) -> np.ndarray:
    """
