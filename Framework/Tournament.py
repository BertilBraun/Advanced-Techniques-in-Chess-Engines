...
class CompetitionStatistics(dict[ChessBot, Statistics]):
    ...
    def _update_statistics(
        self, white: ChessBot, black: ChessBot, result: GameResult, thinking_time: ThinkingTime
    ) -> None:
...
class TournamentResults:
    ...
    competition_results: dict[
        tuple[int, int], CompetitionStatistics
    ]  # (i, j) -> CompetitionStatistics where i, j are the indices of the participants that competed
...
class Tournament:
    ...
    def _aggregate_results(
        self, competition_results: dict[tuple[int, int], CompetitionStatistics]
