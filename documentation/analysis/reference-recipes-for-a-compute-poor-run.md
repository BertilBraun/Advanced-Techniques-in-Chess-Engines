...
- **KataGo, policy surprise weighting.** Roughly half the total frequency weight is spread uniformly and
  ...
  earlier runs" ([KataGoMethods.md](https://github.com/lightvector/KataGo/blob/v1.17.1/docs/KataGoMethods.md)).
...
([SelfplayTraining.md](https://github.com/lightvector/KataGo/blob/v1.17.1/SelfplayTraining.md)). ELF OpenGo
...
([KataGo docs](https://github.com/lightvector/KataGo/blob/v1.17.1/docs/KataGoMethods.md)). That is PCR without
...
- KataGo methods documentation —
  https://github.com/lightvector/KataGo/blob/v1.17.1/docs/KataGoMethods.md
- KataGo self-play training guide —
  https://github.com/lightvector/KataGo/blob/v1.17.1/SelfplayTraining.md
