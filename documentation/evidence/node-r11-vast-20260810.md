...
The `vast-r11-*` configuration files were removed from the tree (they no longer resolve against the
current schema and evaluation assets); they remain available in git history at this exercise's revision.
...
[self-play throughput baseline](../benchmarks/self-play-throughput-4xrtx3060-20260809/README.md).
