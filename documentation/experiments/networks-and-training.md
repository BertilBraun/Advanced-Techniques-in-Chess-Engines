...
| Hybrid / transformer trunk | **Proposed only** | No separate hybrid or transformer production experiment is documented beyond the attention-family studies. | [research ledger](../history/historical-research-backlog-20260822.md) |
| Shared policy/value trunk | **Retained** | The production CNN shares its trunk. No controlled late-block separation study is documented, so the project cannot claim trunk sharing beat partial separation. | [Final config](../../py/configs/production/chess-final-config.yaml), [research ledger](../history/historical-research-backlog-20260822.md) |
...
| Other auxiliary heads | **Proposed only** | Future action, uncertainty, root-Q, material, survival, king-safety, control-map, and related heads were not final experiments. | [research ledger](../history/historical-research-backlog-20260822.md) |
...
| EMA/SWA, gradient accumulation, dynamic loss balancing | **Proposed only** | Listed as candidates; no completed efficacy experiment is documented. | [research ledger](../history/historical-research-backlog-20260822.md) |
