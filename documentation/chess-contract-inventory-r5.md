...
| Run approval, model-zero preparation, resolved manifests, and publication provenance bind the complete experiment rather than a projected legacy schema. | `py/src/experiment/chess_run.py` | `py/train.py`, `py/src/train/CreditPublication.py`, `py/src/cluster/EvaluationProcess.py` |
