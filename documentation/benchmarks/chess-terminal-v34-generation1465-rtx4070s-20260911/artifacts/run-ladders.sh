...
exec /workspace/alphazero-engine-venv/bin/python -m tools.run_stockfish_terminal_ladders \
  ...
  --output-root /workspace/postrun/v34-terminal-g1465/ladders \
  --ten-thousand-devices 0 1 2 \
  --eighty-thousand-devices 3 4 5 6 7
