...
- [Python runtime rework](python-runtime-rework.md): accepted runtime topology and process model. Its ingestion
  contract carries an as-built banner — WP2 of the recovery plan reworks that part.
