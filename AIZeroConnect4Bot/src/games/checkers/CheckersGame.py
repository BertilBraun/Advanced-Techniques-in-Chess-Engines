...
class Checkers:
    def __init__(self) -> None:
        ...
        self.current_player: int = 1  # 1 for black, -1 for white
        self._game_over_cache: Optional[int] = None
    ...
    def _black_normal_moves(self, men: int, kings: int, empty: int) -> List[Tuple[int, int]]:
        moves = []
    ...
    def _white_normal_moves(self, men: int, kings: int, empty: int) -> List[Tuple[int, int]]:
        moves = []
    ...
    def _black_captures(self, men: int, kings: int, opp: int, empty: int) -> List[Tuple[int, int]]:
        captures = []
        # Black men captures:
    ...
    def _white_captures(self, men: int, kings: int, opp: int, empty: int) -> List[Tuple[int, int]]:
        captures = []
        # White men captures:
    ...
    def _decode_single_step_moves(self, starts: int, ends: int, shift: int) -> List[Tuple[int, int]]:
    ...
    def make_move(self, start: int, end: int) -> None:
        """
    ...
    def check_winner(self) -> Optional[int]:
        ...
        if not moves:
            ...
            self._game_over_cache = -self.current_player
    ...
    def copy(self) -> Checkers:
        ...
        game._game_over_cache = self._game_over_cache
        return game
