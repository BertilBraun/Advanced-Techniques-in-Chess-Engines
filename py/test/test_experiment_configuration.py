...
def test_optimal_chess_experiment_uses_conservative_search_and_parallel_materialization() -> None:
    ...
    assert configuration.run.hardware.offer_id == 'instance-48042270-machine-79780-host-399360'
...
def test_experiment_configuration_hash_matches_pinned_regression_value() -> None:
    ...
    assert experiment_configuration_sha256(frozen) == 'b80573cb8f4c612340160125d77dbc938863699b1b3bdda0d86b2f10e820d7ea'
