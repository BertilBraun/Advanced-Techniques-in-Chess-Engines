...
class ChessSelfPlaySearchResult:
    ...
    @property
    def predicted_budget_curve(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(10)]: ...
    @property
    def root(self) -> ChessSearchRoot: ...
    @property
...
class PredictedSearchBudgetLimit:
    def __init__(self, baseline_visits: int, policy: SearchBudgetPolicy) -> None: ...
    @property
    def baseline_visits(self) -> int: ...
    @property
    def policy(self) -> SearchBudgetPolicy: ...
