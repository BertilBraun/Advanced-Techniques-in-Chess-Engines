...
class ChessSelfPlaySearchResult:
    ...
    @property
    def stop_features(self) -> list[typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(19)]]: ...
    @property
...
class SearchStopPolicy:
    def __init__(
        self,
        checkpoint_multiples: list[float],
    ...
    @property
    def cap_multiple(self) -> float: ...
    @property
    def checkpoint_multiples(self) -> list[float]: ...
    @property
    def has_predictor(self) -> bool: ...
    @property
    def movement_guard_epsilon(self) -> float: ...
    @property
...
class SearchStopReason:
    ...
    CAP_REACHED: typing.ClassVar[SearchStopReason]  # value = <SearchStopReason.CAP_REACHED: 2>
    FIXED_LIMIT: typing.ClassVar[SearchStopReason]  # value = <SearchStopReason.FIXED_LIMIT: 0>
    LEARNED_EARLY_STOP: typing.ClassVar[SearchStopReason]  # value = <SearchStopReason.LEARNED_EARLY_STOP: 3>
    __members__: typing.ClassVar[
        dict[str, SearchStopReason]
    ]  # value = {'FIXED_LIMIT': <SearchStopReason.FIXED_LIMIT: 0>, 'ADDITIONAL_VISITS': <SearchStopReason.ADDITIONAL_VISITS: 1>, 'CAP_REACHED': <SearchStopReason.CAP_REACHED: 2>, 'LEARNED_EARLY_STOP': <SearchStopReason.LEARNED_EARLY_STOP: 3>}
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class StopCheckpointEvaluation:
    @property
    def guard_movement(self) -> float: ...
    @property
    def guard_passed(self) -> bool: ...
    @property
    def predictor_evaluated(self) -> bool: ...
    @property
    def uncertainty(self) -> float: ...
    @property
    def would_stop(self) -> bool: ...

class StoppableSearchLimit:
    def __init__(
        self, baseline_visits: int, policy: SearchStopPolicy, model_generation: int = 0, shadow_only: bool = False
    ) -> None: ...
    @property
    def baseline_visits(self) -> int: ...
    @property
    def cap_additional_visits(self) -> int: ...
    @property
    def model_generation(self) -> int: ...
    @property
    def policy(self) -> SearchStopPolicy: ...
    @property
    def searches_to_cap(self) -> bool: ...
    @property
...
def evaluate_stop_rule(
    ...
    features: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(19)],
) -> StopCheckpointEvaluation: ...
...
STOP_PREDICTOR_FEATURE_COUNT: int = 19
