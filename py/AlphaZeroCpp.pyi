...
class InferenceStatistics:
    ...
    @property
    def cachePriorBatchRepeats(self) -> int: ...
    @property
    def cacheRepeatRate(self) -> float: ...
    @property
    def cacheRepeatedHashes(self) -> int: ...
    @property
    def cacheSameBatchRepeats(self) -> int: ...
    @property
    def cacheSetSize(self) -> int: ...
    @property
    def cacheTotalPositions(self) -> int: ...
    @property
    def cacheUniqueHashes(self) -> int: ...
    @property
...
class ChessSelfPlaySearch:
    ...
    def inference_statistics(self) -> InferenceStatistics: ...
    def reset_inference_cache_tracker(self) -> None: ...
