...
class ChessSelfPlaySearch:
    ...
    def refresh_model(self, model_generation: int, model_path: str, backend: InferenceBackend) -> None: ...
    def request(
        self,
...
class InferenceBackend:
    ...
    TENSORRT: typing.ClassVar[InferenceBackend]  # value = <InferenceBackend.TENSORRT: 1>
    TORCHSCRIPT: typing.ClassVar[InferenceBackend]  # value = <InferenceBackend.TORCHSCRIPT: 0>
    __members__: typing.ClassVar[
        dict[str, InferenceBackend]
    ]  # value = {'TORCHSCRIPT': <InferenceBackend.TORCHSCRIPT: 0>, 'TENSORRT': <InferenceBackend.TENSORRT: 1>}
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class SearchStopReason:
    ...
    ]  # value = {'FIXED_LIMIT': <SearchStopReason.FIXED_LIMIT: 0>, 'ADDITIONAL_VISITS': <SearchStopReason.ADDITIONAL_VISITS: 1>}
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class SelfPlaySearchParameters:
    ...
    tree_search: TreeSearchParameters
    def __init__(
        self, baseline_visits: int, tree_search: TreeSearchParameters, dirichlet_alpha: float, dirichlet_epsilon: float
    ) -> None: ...
