...
class ChessSelfPlaySearch:
    ...
    def request(
        self, root: ChessSearchRoot, full_search: bool, checkpoint_detail: SearchCheckpointDetail = ...
    ) -> ChessSelfPlaySearchRequest: ...
    def search(
...
class GoSelfPlaySearch7:
    ...
    def refresh_model(self, model_generation: int, model_path: str) -> None: ...
    def request(
        self, root: GoSearchRoot7, full_search: bool, checkpoint_detail: SearchCheckpointDetail = ...
    ) -> GoSelfPlaySearchRequest7: ...
    def search(
...
class GoSelfPlaySearch9:
    ...
    def refresh_model(self, model_generation: int, model_path: str) -> None: ...
    def request(
        self, root: GoSearchRoot9, full_search: bool, checkpoint_detail: SearchCheckpointDetail = ...
    ) -> GoSelfPlaySearchRequest9: ...
    def search(
...
class SearchStopReason:
    ...
    ]  # value = {'FIXED_LIMIT': <SearchStopReason.FIXED_LIMIT: 0>, 'DETERMINISTIC': <SearchStopReason.DETERMINISTIC: 1>, 'LEARNED_GATE': <SearchStopReason.LEARNED_GATE: 2>, 'MAXIMUM': <SearchStopReason.MAXIMUM: 3>}
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
