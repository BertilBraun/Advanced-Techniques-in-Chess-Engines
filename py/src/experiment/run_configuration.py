...
class WorkloadConfiguration(FrozenModel):
    ...
    disagreement_prefix_maximum_ply: int = Field(default=10, ge=1, le=10)
...
def apply_run_configuration(
    ...
    training_args.self_play.disagreement_prefix_start_probability = workload.disagreement_prefix_start_probability
    training_args.self_play.disagreement_prefix_maximum_ply = workload.disagreement_prefix_maximum_ply
    ...
    training_args.self_play.direct_inference = (
        DirectSelfPlayParams(
            inference_workers=topology.direct_self_play_inference_workers,
            inference_batch_size=topology.direct_self_play_inference_batch_size,
            outstanding_batches_per_worker=topology.direct_self_play_outstanding_batches_per_worker,
        )
        if topology.direct_self_play_inference_workers > 0
        else None
    )
