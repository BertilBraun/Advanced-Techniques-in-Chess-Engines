...
NUM_SELF_PLAYERS = 8 * (torch.cuda.device_count() - 1) if USE_GPU else 2
NUM_THREADS = round(multiprocessing.cpu_count() / NUM_SELF_PLAYERS * 2)
PARALLEL_GAMES = NUM_THREADS * 128
