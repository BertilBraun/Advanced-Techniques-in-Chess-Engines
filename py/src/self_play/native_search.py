...
class NativeSearchResult(Protocol[NativeRootT]):
    ...
    @property
    def stop_checkpoint_index(self) -> int: ...

    @property
    def stop_probabilities(self) -> list[float]: ...

    @property
    def guard_movements(self) -> list[float]: ...

    @property
    def stop_verdicts(self) -> list[int]: ...

    @property
    def stop_features(self) -> list[tuple[float, ...]]: ...
...
class NativeSelfPlaySearch(Protocol[PositionT, NativeRootT, NativeRequestT, NativeResultT]):
    def new_root(self, position: PositionT, maximum_capacity: int = 0) -> NativeRootT: ...
