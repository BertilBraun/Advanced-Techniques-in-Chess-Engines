...
- **Self-Play**: Chess games are generated by the native MCTS engine and saved as training datasets under Python supervision.
- **Training**: Persistent DDP ranks train exact optimizer quanta from the rolling replay when enough presentation credits exist.
