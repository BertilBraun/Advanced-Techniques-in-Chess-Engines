...
from tools.attention_viability_cells import ARCHITECTURE_CELLS, HEAD_CONTROL_CELLS, SUPPLEMENTARY_CELLS, cell_by_name
...
def main() -> None:
    ...
    for cell in ARCHITECTURE_CELLS + SUPPLEMENTARY_CELLS + HEAD_CONTROL_CELLS:
