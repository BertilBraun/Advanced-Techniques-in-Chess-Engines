...
| R2 | Credit-only training lifecycle and commander cleanup | in_progress |
...
Current authorization: R1 accepted; R2 review revisions in progress. No later phase is authorized.
