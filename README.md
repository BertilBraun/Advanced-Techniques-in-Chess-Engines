...
AlphaZero-style research on Go. The active implementation is Go-only:
...
Playing-strength claims and the six-hour multi-GPU runs are intentionally
deferred until separate compute is rented.
...
The architecture, research contracts, and migration record are in
